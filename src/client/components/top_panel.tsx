  ...
  render() {
    ...
    return (
      <Menu secondary inverted color="blue" className={noMargin}>
        ...
        <Dropdown item icon="mobile alternate">
          <Dropdown.Menu>
            <Dropdown.Header>Resolution</Dropdown.Header>
            {this.props.state.viewState.resolutions.map((r, i) => (
              <Dropdown.Item
                key={i}
                onClick={r.click}
                selected={r.active}
                icon="mobile alternate"
                className={r.tilt ? tilt : ''}
                content={r.name}
              />
            ))}
          </Dropdown.Menu>
        ...
        <Menu.Menu position="right">
          <Menu.Item
            ...
            onClick={this.props.state.viewState.maximise}
            title="Maximise component"
          />
